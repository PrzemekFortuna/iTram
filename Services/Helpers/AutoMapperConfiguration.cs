        ...
        public static IMapper Initialize()
        {
            var config = new MapperConfiguration(cfg =>
            {
                ...
                cfg.CreateMap<SensorsReading, SensorsReadingDTO>()
                    ...
                    .ForMember(dest => dest.VehicleLatitude, opts => opts.MapFrom(src => src.VehicleLocation.VehicleLatitude))
                    .ForMember(dest => dest.VehicleLongitude, opts => opts.MapFrom(src => src.VehicleLocation.VehicleLongitude))
